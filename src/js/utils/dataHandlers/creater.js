...
if (
  ...
  window.location.pathname == '/Auction-House/create.html'
) {
  ...
  //handles the media input and adds embeded image links to the form
  ...
  let auctionCreateHandler = auctionCreateForm.addEventListener(
    'submit',
    async (e) => {
      e.preventDefault()

      //sends the data to the api and checks for token
